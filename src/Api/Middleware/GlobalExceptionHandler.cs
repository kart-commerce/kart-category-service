...
/// api-contract.yaml's Problem shape (ProblemDto) - so handlers/controllers never need their own
/// try/catch. FluentValidation's ValidationException (thrown by ValidationBehavior, never caught
