...
/// Result/Either pattern - not exceptions") into the HTTP status/Problem shape api-contract.yaml
/// specifies per endpoint (400 for validation/max-depth/circular-reference, 404 for not-found).
/// </summary>
public static class ResultExtensions
{
    ...
    public static ActionResult MapFailure(this ControllerBase controller, Error error)
    {
        ...
        return error.Code switch
        {
            ...
            "validation_error" or "max_depth_exceeded" or "circular_reference" => controller.BadRequest(problem),
